// Die Datei baut in Verbindung mit einem ESP32 eine Webschnittstelle auf,
// über die die interne LED des ESP-Boards geschaltet wird
...
const char* htmlPage = R"=====(
  ...
  <head>
    ...
    <script>
      ...
      setInterval(fetchAnalogValue, 200);  // Alle 0.2 Sekunde den Wert abrufen
    </script>
  </head>
  <body>
...
void handleAnalogValue() {
  int analogValue = analogRead(analogPin);  // Lese den analogen Wert von Pin D34
